...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams FULL JOIN games AS g1 ON teams.team_id = g1.opponent_id FULL JOIN games AS g2 ON teams.team_id = g2.winner_id WHERE g1.year = 2014 OR g2.year = 2014")"
